                ...
                <div class="cnt-body">
                        ...
                        <div class="info">
                            <div class="prof">
                                ...
                                <div class="id">
                                    ...
                                    <p style="font-size: smaller;">{{'@'. $tweet->user->username}}</p>
                    ...
                    <div class="comments">
                        ...
                        <div class="com-bd">
                            ...
                            <a href="/profile"> <img class="p-photo" src="/storage/{{$comment->user->profile->pphoto}}"
                                    alt=""></a>
                            @else
                            ...
                            <div class="details">
                                ...
                                <p style="color:gray">replying to <span style="color:rebeccapurple; cursor:pointer">
