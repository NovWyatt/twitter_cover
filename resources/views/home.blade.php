                ...
                <div class="cnt-body">
                        ...
                        <div class="prefrence" id="forYou">
                            ...
                            <a title="{{ $tweet->user->username . ' tweet' }}" href="/tweet/{{ $tweet->id }}" id="content" style="text-decoration: none; color:black;">
                                <div class="view-tweet">
                                    <div class="info">
                                        <div class="prof">
                                        <img class="p-photo" src="{{ $tweet->user->profile->pphoto ? asset('storage/' . $tweet->user->profile->pphoto) : asset('storage/profilePhoto/default.jpeg') }}" alt="">
                                            <div class="id">
                                ...
                                <div class="image-post">
                                    <img class="img-upload" src="{{ asset('storage/' . $tweet->image) }}" alt="">
                                </div>
                                @endif
                                <ul class="reactions">
                                    ...
                                    <li><img class="l-react" src="/icon/heart.svg" alt="">{{ isset($tweet->likes) ? count($tweet->likes) : 0 }}</li>
                                </ul>
                            </a>
                            @endforeach
                            @else
                    ...
                    <div class="prefrence" id="following" style="display: none">
                        ...
                        <a href="/tweet/{{$tweet['id']}}" id="content" style="text-decoration: none; color:black;">
                            ...
                            <ul class="reactions">
                                <li> <img class="l-react" src="icon/chat.svg" alt="">{{count($tweet->comments)}}</li>
                                <li> <img class="l-react" src="/icon/bookmark.svg" alt="">{{count($tweet->bookmarks)}}
                                </li>
                                <li> <img class="l-react" src="icon/heart.svg" alt="">{{ isset($tweet->likes) ? count($tweet->likes) : 0 }}</li>
                            </ul>
                        </a>
